...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
   ...
   * @return list of transactions
   */
  List<Transaction> findByUserEmailAndDateBetween(String email, Date fromDate, Date toDate,
      Sort sort);

  /**
   * Looks for transactions by user's email, which were created between given dates, and theirs
   * 'comment' field contains given string.
   *
   * @param email user's email
   * @param fromDate date 'from'
   * @param toDate date 'to'
   ...
   * @return list of transactions
   */
  List<Transaction> findByUserEmailAndDateBetweenAndCommentLikeIgnoreCase(String email,
      Date fromDate, Date toDate,
      String comment, Sort sort);

  /**
   * Looks for transactions by given accounts, which were created between given dates, and theirs
   * 'comment' field contains given string.
   *
   * @param account transaction's account
   * @param transferAccount transfer account in a case if transaction has operation TRANSFER
   ...
   * @return list of transactions
   */
  List<Transaction> findByAccountOrTransferAccountAndDateBetweenAndCommentLikeIgnoreCase(
      Account account,
   ...
   * @return list of transactions
   */
  List<Transaction> findByAccountOrTransferAccountAndDateBetween(Account account,
      Account transferAccount,
